        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <Link :href="route('dashboard')" class="flex items-center justify-between mr-4">
                    ...
                    <span class="ms-2 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Laravue Shop</span>
                </Link>
            ...
            <div class="flex items-center lg:order-2">
              ...
              >
                  ...
                  <span class="flex items-center">
                    ...
                    >
                        <li>
                            <Link :href="route('logout')" method="post" as="button" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                Sign out
                            </Link>
                        </li>
                    </ul>
